...
% Replace accordingly
\title{\huge{Hybrid AI-Driven Supply Chain Analytics Solution for Consumer Goods}}
\author{Vinuka Shavin Silva}
\degreetitle{BSc (Hons) in Artificial Intelligence and Data Science}
\rpttype{Degree}
\principaladviser{Mr. Prashan Rathnayaka}
