...
\noindent Date: 2026-04-05 \\[0.5cm]
\noindent Supervisor's Name: Bimali Wickramasinghe
...
\abbrev{CHI}{Conference on Human Factors in Computing Systems}
...
\abbrev{PANGeA}{Procedural Adaptive Narrative using a Game Architecture}
